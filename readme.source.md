...
<div style={{
  ...
  <div style={{ display: 'flex', flexDirection: 'column', zIndex: 10 }}>
    <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 10 }}>
      <svg viewBox="0 0 24 24" width="18" height="18" fill="none" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: 2 }}>
        <path stroke="#ec4899" d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
        <circle stroke="#ec4899" cx="12" cy="7" r="4" />
      </svg>
      ...
      {[
        {
          label: 'High Schooler',
          icon: (
            <svg viewBox="0 0 24 24" width="12" height="12" fill="none" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: 4 }}>
              <path stroke="#cbd5e1" d="M22 10v6M2 10l10-5 10 5-10 5z" />
              <path stroke="#cbd5e1" d="M6 12v5c0 2 2 3 6 3s6-1 6-3v-5" />
            </svg>
          )
        },
        {
          ...
          icon: (
            <svg viewBox="0 0 24 24" width="12" height="12" fill="none" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: 4 }}>
              <path stroke="#cbd5e1" d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" />
            </svg>
          )
        },
        {
          ...
          icon: (
            <svg viewBox="0 0 24 24" width="12" height="12" fill="none" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: 4 }}>
              <line stroke="#cbd5e1" x1="6" y1="12" x2="10" y2="12" />
              <line stroke="#cbd5e1" x1="8" y1="10" x2="8" y2="14" />
              <line stroke="#cbd5e1" x1="15" y1="13" x2="15.01" y2="13" />
              <line stroke="#cbd5e1" x1="18" y1="11" x2="18.01" y2="11" />
              <rect stroke="#cbd5e1" x="2" y="6" width="20" height="12" rx="3" />
            </svg>
          )
        },
        {
          ...
          icon: (
            <svg viewBox="0 0 24 24" width="12" height="12" fill="none" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: 4 }}>
              <rect stroke="#cbd5e1" x="3" y="11" width="18" height="10" rx="2" />
              <circle stroke="#cbd5e1" cx="12" cy="5" r="2" />
              <path stroke="#cbd5e1" d="M12 7v4M9 16h6M8 14h.01M16 14h.01" />
            </svg>
          )
        }
      ].map(tag => (
...
<div style={{
  ...
  <div style={{ display: 'flex', alignItems: 'center', gap: 8, zIndex: 10 }}>
    <svg viewBox="0 0 24 24" width="16" height="16" style={{ marginRight: 2 }}>
      <path fill="#7dd3fc" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
    </svg>
...
<div style={{
  ...
  <div style={{ display: 'flex', alignItems: 'center', gap: 8, zIndex: 10 }}>
    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: 2 }}>
      <rect stroke="#fda4af" x="2" y="2" width="20" height="20" rx="5" ry="5" />
      <path stroke="#fda4af" d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37zM17.5 6.5h.01" />
    </svg>
...
<div style={{
  ...
  <div style={{
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 12 }}>
      <svg viewBox="0 0 24 24" width="18" height="18" fill="none" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: 2 }}>
        <circle stroke="#fb923c" cx="12" cy="12" r="3" />
        <path stroke="#fb923c" d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51-1z" />
      </svg>
  ...
  <div style={{
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 12 }}>
      <svg viewBox="0 0 24 24" width="18" height="18" fill="none" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: 2 }}>
        <path stroke="#4ade80" d="M12 22V12" />
        <path stroke="#4ade80" d="M12 12c0-2.8 2.2-5 5-5h4v4c0 2.8-2.2 5-5 5h-4" />
        <path stroke="#4ade80" d="M12 16c0-2.2-1.8-4-4-4H4v4c0 2.2 1.8 4 4 4h4" />
        <path stroke="#4ade80" d="M12 12c0-3.3-2.7-6-6-6H2v6c0 3.3 2.7 6 6 6h4" />
      </svg>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8, flex: 1, justifyContent: 'center' }}>
      {[
        ...
        <div key={goal} style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
          <svg viewBox="0 0 24 24" width="12" height="12" fill="none" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: 4, flexShrink: 0 }}>
            <polyline stroke="#818cf8" points="9 18 15 12 9 6" />
          </svg>
...
<div style={{
  ...
  <div style={{
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8 }}>
      <svg viewBox="0 0 24 24" width="18" height="18" fill="none" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: 2 }}>
        <path stroke="#fb7185" d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
      </svg>
  ...
  <div style={{
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 10 }}>
      <svg viewBox="0 0 24 24" width="18" height="18" fill="none" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: 2 }}>
        <circle stroke="#34d399" cx="12" cy="12" r="10" />
        <circle stroke="#34d399" cx="12" cy="12" r="6" />
        <circle stroke="#34d399" cx="12" cy="12" r="2" />
      </svg>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 6, justifyContent: 'center', flex: 1 }}>
      {[
        ...
        <div key={goal} style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
          <svg viewBox="0 0 24 24" width="12" height="12" fill="none" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: 4, flexShrink: 0 }}>
            <polyline stroke="#34d399" points="9 18 15 12 9 6" />
          </svg>
